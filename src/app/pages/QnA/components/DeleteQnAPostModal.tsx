...
import { deleteQnaPost } from "../backend/qnaService";

export function DeleteQnAPostModal({
  open,
  onClose,
  postId,
  onDeleted,
  ...
  async function handleDelete() {
    ...
    try {
      ...
      if (!authUid) {
        toast.error("You must be logged in to delete this post.");
        setIsDeleting(false);
        return;
      }

      await deleteQnaPost({ postId, authorId: authUid });
